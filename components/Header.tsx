...
export default function Header() {
    return(
        <header className="lg:sticky top-0 flex items-start justify-center sm:justify-between max-w-7xl mx-auto z-20 xl:items-center p-5">
            <motion.div
            initial={{
                x: -500,
                opacity: 0,
            ...
            className="flex flex-row items-center">
                ...
                <SocialIcon url="https://wa.link/mb9ofo" network="whatsapp" fgColor="gray" bgColor="transparent" target="_blank" />
